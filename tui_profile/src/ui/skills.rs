...
pub const SKILL_NODES: &[SkillNode] = &[
    SkillNode {
        ...
        y: 11,
        parents: &[],
        desc: "Foundational core of systems architecture, hardware emulation, and machine learning models.",
        level: "Root",
    ...
    SkillNode {
        ...
        y: 9,
        parents: &["core"],
        desc: "Low-level system software development, performance profiling, and custom runtime tools.",
        level: "Expert",
    ...
    SkillNode {
        ...
        y: 7,
        parents: &["cpp"],
        desc: "Bare-metal instruction sets, bootloaders, register manipulation, and debugging.",
        level: "Intermediate",
    ...
    SkillNode {
        ...
        y: 11,
        parents: &["cpp"],
        desc: "Hobby operating system kernels, virtual memory management, interrupt handling.",
        level: "Expert",
    ...
    SkillNode {
        ...
        y: 13,
        parents: &["core"],
        desc: "Memory-safe systems programming, concurrency, tokio runtime, and WASM compilation.",
        level: "Expert",
        nav: ["cpp", "cuda", "dist", "core"],
    },
    SkillNode {
        id: "dist",
        ...
        y: 15,
        parents: &["rust"],
        desc: "Consensus engines (Raft), message queues, RPC serialization, and horizontal scaling.",
        level: "Advanced",
        nav: ["os", "cuda", "os", "rust"],
    },
    SkillNode {
        ...
        y: 17,
        parents: &["rust"],
        desc: "Parallel GPGPU programming, memory coalescing, shared memory optimization, and custom kernels.",
        level: "Intermediate",
        nav: ["rust", "cp", "dist", "docker"],
    },
    SkillNode {
        id: "linux",
        ...
        y: 3,
        parents: &["os"],
        desc: "Writing kernel modules, modifying device drivers, and configuring virtual file systems.",
        level: "Advanced",
        nav: ["git", "asm", "asm", "mem"],
    },
    SkillNode {
        ...
        y: 5,
        parents: &["os"],
        desc: "Custom allocators, slab allocation, buddy system, virtual page translation, TLB profiling.",
        level: "Expert",
    ...
    SkillNode {
        ...
        y: 9,
        parents: &["core"],
        desc: "Data analysis, scientific computing, PyTorch models, scripting, and system scripting.",
        level: "Expert",
    ...
    SkillNode {
        ...
        y: 7,
        parents: &["py"],
        desc: "Neural network modeling, custom autograd operators, distributed training pipelines.",
        level: "Expert",
        nav: ["vim", "dl", "py", "dl"],
    },
    SkillNode {
        ...
        y: 11,
        parents: &["pytorch"],
        desc: "Supervised and unsupervised architectures, CNNs, Transformers, optimization dynamics.",
        level: "Advanced",
    ...
    SkillNode {
        ...
        y: 13,
        parents: &["py"],
        desc: "Real-time image manipulation, custom filters, convolution matrices, OpenCV C++ bindings.",
        level: "Advanced",
        nav: ["py", "opt", "core", "dl"],
    },
    SkillNode {
        ...
        y: 17,
        parents: &["dl"],
        desc: "Neural network weight pruning, INT8/FP16 post-training quantization, and distillation.",
        level: "Advanced",
        nav: ["opencv", "trt", "cuda", "trt"],
    },
    SkillNode {
        id: "trt",
        ...
        y: 19,
        parents: &["opt"],
        desc: "Compiling optimized TensorRT engines, profiling GPU layers, deploying edge-AI models.",
        level: "Advanced",
        nav: ["cv", "cicd", "opt", "cicd"],
    },
    // Tools Branch
    SkillNode {
        id: "shell",
        ...
        y: 4,
        parents: &["core"],
        desc: "POSIX command line environments, pipelines, writing complex bash/zsh automation scripts.",
        level: "Expert",
    ...
    SkillNode {
        ...
        y: 0,
        parents: &["shell"],
        desc: "Version control, Git workflows, submodule systems, rebasing, bisecting, and GitHub APIs.",
        level: "Expert",
    ...
    SkillNode {
        ...
        y: 3,
        parents: &["shell"],
        desc: "Highly tailored terminal modal editing workflow, custom Lua configs, and quick editing.",
        level: "Expert",
    ...
    SkillNode {
        ...
        y: 18,
        parents: &["core"],
        desc: "Building lightweight reproducible runtime containers, docker-compose, multi-stage builds.",
        level: "Advanced",
        nav: ["core", "cicd", "cuda", "opt"],
    },
    SkillNode {
        id: "cicd",
        ...
        y: 21,
        parents: &["docker"],
        desc: "GitHub Actions pipelines, automated regression testing, static code analysis, CD deployment.",
        level: "Advanced",
        nav: ["docker", "docker", "cp", "trt"],
    },
    SkillNode {
        id: "cp",
        ...
        y: 21,
        parents: &["core"],
        desc: "Advanced algorithms, data structures (Segment Trees, Trie), runtime complexity optimization.",
        level: "Expert",
        nav: ["cuda", "cicd", "cuda", "cicd"],
    },
];
